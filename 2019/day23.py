...
class Nat:
    ...
    def update(self):
        self.last_delivered_packet = self.current_packet


class Network:
    def __init__(self, hosts, nat_address=255):
        self.hosts = 50
        self.nat = Nat(nat_address)
    ...
    def is_idle(self):
        return all(q == [] for q in self.packet_queue.values())
